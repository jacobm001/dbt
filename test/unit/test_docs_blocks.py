...
from dbt.contracts.graph.manifest import SourceFile, FileHash, FilePath
...
class DocumentationParserTest(unittest.TestCase):
    ...
    def test_load_file(self):
        parser = docs.DocumentationParser(project=self.subdir_project_config)

        file_block = self._build_file(TEST_DOCUMENTATION_FILE, 'test_file.md')

        results = sorted(parser.parse_file(file_block), key=lambda n: n.name)
